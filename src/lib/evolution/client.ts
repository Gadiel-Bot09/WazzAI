...
export class EvolutionClient {
   ...
   * Usa el formato flat confirmado con esta versión de Evolution API.
   */
  async sendMedia(
    instanceId: string,
    phone: string,
    ...
    // Formato flat confirmado con esta versión de Evolution API
    ...
    console.log(`[Evolution] sendMedia [${mediaType}]:`, body)
